            ...
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 30, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 100, padding: 10, backgroundColor: '#56b3f1', borderRadius: 10, shadowColor: "#000", 
                            ...
                            <View style={{ marginTop: 10 }}>
                                <Text style={{ fontWeight: '900', fontSize: 18, color: '#fff' }}>Books</Text>
                            </View>
