            ...
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 30, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 90, paddingTop: 20, backgroundColor: '#6ab9ee', borderRadius: 10, shadowColor: "#000", 
                            ...
                            <View style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 5 }}>
                                <MaterialCommunityIcons name={'bookshelf'} size={25} color={'#fff'} />
                                <Text style={{ fontWeight: '900', fontSize: 25, color: '#fff' }}>500</Text>
                            </View>
