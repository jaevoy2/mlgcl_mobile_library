            ...
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 30, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 100, padding: 20, backgroundColor: '#6ab9ee', borderRadius: 10, shadowColor: "#000", 
                            ...
                            <Image source={bookImg} style={{ height: 120, width: 120, position: 'absolute', right: 10, top: -20 }} />
                        </View>
                    </View>
                </>
            )}
