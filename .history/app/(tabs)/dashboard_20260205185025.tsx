            ...
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 20, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 80, padding: 10, backgroundColor: '#3498db', borderRadius: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 6, }}>
