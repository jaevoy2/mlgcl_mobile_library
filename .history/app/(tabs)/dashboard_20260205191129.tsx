                ...
                <>
                    ...
                    <View style={{ paddingTop: 30, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 100, padding: 20, borderRadius: 10, shadowColor: "#000", 
                            shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 10, elevation: 6, position: 'relative' }}>
                                <LinearGradient
                                    colors={['#3498db', 'rgba(52, 152, 219, 0.88)',  'rgba(52, 152, 219, 0.75)', 'rgba(241, 196, 15, 0.57)',]}
                                    start={{ x: 0, y: 1 }}
                                    end={{ x: 1, y: 1 }}
                                    style={{ height: '100%', position: 'absolute', width: '109%', top: 0, right: 7, zIndex: -1, borderRadius: 10 }}
                                />
