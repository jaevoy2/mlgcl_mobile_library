...
export default function BooksView() {
    ...
    return (
        <View style={{ backgroundColor: '#ebeaea', flex: 1 }}>
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 20, paddingHorizontal: 20 }}>
                        <View style={{ paddingLeft: 8, borderWidth: 1, backgroundColor: '#fff', borderColor: '#afafaf', backgroundColor: '#eeeded', flexDirection: 'row', justifyContent: 'space-between', borderRadius: 50 }}>
