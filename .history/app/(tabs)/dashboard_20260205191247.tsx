            ...
            {loading == true ? (
                ...
                <>
                    ...
                    <View style={{ paddingTop: 30, paddingHorizontal: 20 }}>
                        <View style={{ width: '100%', height: 100, padding: 20, borderRadius: 10, shadowColor: "#000", backgroundColor: '#3498db'
                            shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 6, elevation: 6, position: 'relative' }}>
                                {/* <LinearGradient
                                    ...
                                    style={{ height: 100, position: 'absolute', width: '109%', bottom: 0, right: 7, zIndex: -1, borderRadius: 10 }}
                                /> */}
